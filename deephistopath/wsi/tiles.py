...
def generate_tile_summaries(tile_sum, np_img, display=True, save_summary=False,
  ...
  summary_orig = create_summary_pil_img(np_orig, z, row_tile_size, col_tile_size, num_row_tiles, num_col_tiles, slinfo=slinfo)
...
def save_tile_summary_on_original_image(pil_img, slide_num, slinfo: SlideInfo = None):
  ...
  t = Time()
  thumbnail_filepath = slide.get_tile_summary_on_original_thumbnail_path(slide_num, slinfo=slinfo)
  slide.save_thumbnail(pil_img, slide.THUMBNAIL_SIZE, thumbnail_filepath)
  print(
...
def save_top_tiles_on_original_image(pil_img, slide_num, slinfo: SlideInfo = None):
  ...
  t = Time()
  thumbnail_filepath = slide.get_top_tiles_on_original_thumbnail_path(slide_num, slinfo=slinfo)
  slide.save_thumbnail(pil_img, slide.THUMBNAIL_SIZE, thumbnail_filepath)
  print(
...
def summary_and_tiles(slide_num, display=True, save_summary=False, save_data=True, save_top_tiles=True,
  ...
  generate_tile_summaries(tile_sum, np_img, display=display, save_summary=save_summary, slinfo=slinfo)
  generate_top_tile_summaries(tile_sum, np_img, display=display, save_summary=save_summary, slinfo=slinfo)
