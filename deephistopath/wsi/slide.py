...
#
# ------------------------------------------------------------------------
from tdb.tdbopenslide import TileDBOpenSlide, SlideInfo
...
# Hardcode the slide number for TileDB UDF
FIXED_SLIDE_NUMBER = 1
...
class SlidePathInfo:
  def get_training_thumbnail_path(self, slide_number, large_w=None, large_h=None, small_w=None, small_h=None):
    """
  ...
  def get_filter_image_path(self, slide_number, filter_number, filter_name_info):
    """
  ...
  def get_filter_thumbnail_path(self, slide_number, filter_number, filter_name_info):
    """
  ...
  def get_filter_image_filename(self, slide_number, filter_number, filter_name_info, thumbnail=False):
    pass

  def get_tile_summary_image_path(self, slide_number):
    pass

  def get_tile_summary_thumbnail_path(self, slide_number):
    pass


  def get_tile_summary_on_original_image_path(self, slide_number):
    pass

  def get_tile_summary_on_original_thumbnail_path(self, slide_number):
    pass

  def get_top_tiles_on_original_image_path(self, slide_number):
    pass

  def get_top_tiles_on_original_thumbnail_path(self, slide_number):
    pass

  def get_tile_summary_image_filename(self, slide_number, thumbnail=False):
    pass

  def get_top_tiles_image_filename(self, slide_number, thumbnail=False):
    pass

  def get_top_tiles_thumbnail_path(self, slide_number):
    pass

  def get_tile_data_filename(self, slide_number):
    pass

  def get_tile_data_path(self, slide_number):
    pass

  def get_filter_image_result(self, slide_number):
    pass

  def get_filter_thumbnail_result(self, slide_number):
    pass

  def parse_dimensions_from_image_filename(self, filename):
    pass
...
def get_training_image_path(
  ...
  """
  if slinfo and (large_w is None and large_h is None and small_w is None and small_h is None):
    #large_w, large_h = slinfo.slide.dimensions
    #small_w, small_h  = slinfo.slide.level_dimensions[slinfo.target_downsample_level]

    large_w, large_h, small_w, small_h = slide_to_scaled_pil_image_dims(slide_number, slinfo=slinfo)
...
def get_tile_summary_image_path(slide_number, slinfo: SlideInfo = None):
  ...
  img_path = os.path.join(TILE_SUMMARY_DIR, get_tile_summary_image_filename(slide_number, slinfo=slinfo))
  return img_path
...
def get_tile_summary_on_original_image_path(slide_number, slinfo: SlideInfo = None):
  ...
  img_path = os.path.join(TILE_SUMMARY_ON_ORIGINAL_DIR, get_tile_summary_image_filename(slide_number, slinfo=slinfo))
  return img_path
...
def get_top_tiles_on_original_image_path(slide_number, slinfo: SlideInfo = None):
  ...
  img_path = os.path.join(TOP_TILES_ON_ORIGINAL_DIR, get_top_tiles_image_filename(slide_number, slinfo=slinfo))
  return img_path
...
def get_top_tiles_image_path(slide_number, slinfo: SlideInfo = None):
  ...
  img_path = os.path.join(TOP_TILES_DIR, get_top_tiles_image_filename(slide_number, slinfo=slinfo))
  return img_path
...
def get_top_tiles_thumbnail_path(slide_number, slinfo: SlideInfo = None):
  ...
  img_path = os.path.join(TOP_TILES_THUMBNAIL_DIR, get_top_tiles_image_filename(slide_number, thumbnail=True, slinfo=slinfo))
  return img_path
...
def get_tile_data_path(slide_number, slinfo: SlideInfo = None):
  ...
  file_path = os.path.join(TILE_DATA_DIR, get_tile_data_filename(slide_number, slinfo=slinfo))
  return file_path
...
def training_slide_to_image(slide_number, slinfo: SlideInfo = None):
  ...
  img, large_w, large_h, new_w, new_h = slide_to_scaled_pil_image(slide_number, slinfo=slinfo)

  img_path = get_training_image_path(slide_number, large_w, large_h, new_w, new_h, slinfo=slinfo)
...
def image_to_scaled_pil_image(slide_number, input_image, slinfo: SlideInfo = None):
  ...
  assert input_image.shape[:2] == level_dims, \
...
def image_to_scaled_np_image(slide_number, input_image, slinfo: SlideInfo = None):
  pil_img, large_w, large_h, new_w, new_h = image_to_scaled_pil_image(slide_number, input_image, slinfo=slinfo)
  np_img = util.pil_to_np_rgb(pil_img)
  return np_img, large_w, large_h, new_w, new_h


def slide_to_scaled_np_image(slide_number, slinfo: SlideInfo = None):
  """
  ...
  """
  pil_img, large_w, large_h, new_w, new_h = slide_to_scaled_pil_image(slide_number, slinfo=slinfo)
  np_img = util.pil_to_np_rgb(pil_img)
  return np_img, large_w, large_h, new_w, new_h
