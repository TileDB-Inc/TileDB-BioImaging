...
def apply_filters_to_image_array(
  slide_num, img=None, save=True, display=False, result_path=None, thumbnail_path=None,
  ...
  """
  if img is None:
    raise ValueError("Expected img, got None")
...
def apply_filters_to_image(slide_num, **args):
  ...
  return apply_filters_to_image_array(slide_num, **args, img=np_orig, result_path=result_path,
