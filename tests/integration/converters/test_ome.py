...
@pytest.mark.parametrize("format_path", ["CMU-1-Small-Region.tiledb",
                                         "CMU-1-Small-Region-Zarr.tiledb"])
def test_ome(format_path):
    ...
    assert (t.level_info[0] == LevelInfo(abspath="", level=0, schema=reference_schema[0])
